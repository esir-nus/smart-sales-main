...
includeModule(":data:habit")
includeModule(":data:memory")
includeModule(":data:crm")
includeModule(":data:session")
...
includeModule(":core:test-fakes-domain")
includeModule(":core:test-fakes-platform")
...
includeModule(":domain:scheduler")
