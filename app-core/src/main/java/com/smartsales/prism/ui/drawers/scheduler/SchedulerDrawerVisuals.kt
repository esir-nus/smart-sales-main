...
data class SchedulerDrawerVisuals(
    ...
    val shelfHeaderHover: Color,
    val shelfDeleteRevealBackground: Color,
    val shelfDeleteRevealForeground: Color,
    val shelfLeadingTileBackground: Color,
    val shelfLeadingTileIcon: Color,
    val shelfAiBadgeBackground: Color,
    val shelfAiBadgeText: Color,
    val shelfActionIcon: Color,
    val shelfActionIconActive: Color,
    val shelfCardBorder: Color,
...
private val StandardSchedulerDrawerVisuals = SchedulerDrawerVisuals(
    ...
    shelfHeaderHover = BackgroundSurfaceMuted.copy(alpha = 0.4f),
    shelfDeleteRevealBackground = AccentDanger.copy(alpha = 0.10f),
    shelfDeleteRevealForeground = AccentDanger,
    shelfLeadingTileBackground = AccentDanger.copy(alpha = 0.12f),
    shelfLeadingTileIcon = AccentDanger,
    shelfAiBadgeBackground = Color(0xFF141416),
    shelfAiBadgeText = AccentBlue.copy(alpha = 0.9f),
    shelfActionIcon = AccentBlue.copy(alpha = 0.72f),
    shelfActionIconActive = AccentBlue,
    shelfCardBorder = Color.White.copy(alpha = 0.06f),
...
private val SimSchedulerDrawerVisuals = SchedulerDrawerVisuals(
    ...
    shelfHeaderHover = Color.White.copy(alpha = 0.03f),
    shelfDeleteRevealBackground = AccentDanger.copy(alpha = 0.20f),
    shelfDeleteRevealForeground = AccentDanger,
    shelfLeadingTileBackground = AccentDanger.copy(alpha = 0.15f),
    shelfLeadingTileIcon = AccentDanger,
    shelfAiBadgeBackground = Color(0xFF141416),
    shelfAiBadgeText = Color(0xE60A84FF),
    shelfActionIcon = SimHomeHeroTokens.OutgoingBlue.copy(alpha = 0.70f),
    shelfActionIconActive = SimHomeHeroTokens.OutgoingBlue,
    shelfCardBorder = Color.White.copy(alpha = 0.08f),
    ...
    timelineLabelWidth = 52.dp,
    timelineAxisWidth = 16.dp,
    timelineDotSize = 8.dp,
    timelineLineWidth = 1.dp,
    timelineTopInset = 14.dp,
    timelineRailGap = 12.dp,
    timelineCardBottomSpacing = 14.dp,
    timelineBottomFadeHeight = 36.dp,
