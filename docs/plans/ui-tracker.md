...
| Onboarding Prototype Family | Shared 5-wave onboarding transplant for full app and SIM connectivity hosts using one host-driven coordinator | `/home/cslh-frank/.gemini/antigravity/brain/ee69dd2b-df8e-4de5-898f-bb37f0f20839/onboarding_transplant_brief.md` | Transplanting | Visual QA against approved brief and Compose screenshots for both hosts | Approved now: dark monolith background, frosted cards, permissions primer, abstract voice handshake, manual-connect found card, unified provisioning screen, and shared completion wrapper. Deferred: notification/OEM guidance tail, any reintroduction of naming/account/profile steps, and any broader onboarding expansion beyond the approved prototype family. |
