---
name: cnp
description: Commit and Push the working tree. Use when the user says /cnp. Lane-aware - Android trunks (develop, master) auto-branch into a feature branch; platform lanes (platform/harmony, future ios/*) commit in place since they ARE the per-platform delivery branch. Does NOT merge or create PRs.
---
