...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final DashscopeLibraryAccessors laccForDashscopeLibraryAccessors = new DashscopeLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>dashscope</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public DashscopeLibraryAccessors getDashscope() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForDashscopeLibraryAccessors;
    }
    ...
    public static class AliyunLibraryAccessors extends SubDependencyFactory {
        private final AliyunJavaLibraryAccessors laccForAliyunJavaLibraryAccessors = new AliyunJavaLibraryAccessors(owner);
        private final AliyunOssLibraryAccessors laccForAliyunOssLibraryAccessors = new AliyunOssLibraryAccessors(owner);
        private final AliyunTingwuLibraryAccessors laccForAliyunTingwuLibraryAccessors = new AliyunTingwuLibraryAccessors(owner);

        public AliyunLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>aliyun.java</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AliyunJavaLibraryAccessors getJava() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAliyunJavaLibraryAccessors;
        }

        /**
         * Group of libraries at <b>aliyun.oss</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AliyunOssLibraryAccessors getOss() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAliyunOssLibraryAccessors;
        }

        /**
         * Group of libraries at <b>aliyun.tingwu</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AliyunTingwuLibraryAccessors getTingwu() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAliyunTingwuLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AliyunJavaLibraryAccessors extends SubDependencyFactory {
        private final AliyunJavaSdkLibraryAccessors laccForAliyunJavaSdkLibraryAccessors = new AliyunJavaSdkLibraryAccessors(owner);

        public AliyunJavaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>aliyun.java.sdk</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AliyunJavaSdkLibraryAccessors getSdk() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAliyunJavaSdkLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AliyunJavaSdkLibraryAccessors extends SubDependencyFactory {

        public AliyunJavaSdkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>com.aliyun:aliyun-java-sdk-core</b> coordinates and
         * with version reference <b>aliyun.sdk.core</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("aliyun.java.sdk.core");
        }
     ...
     */
    @Deprecated
    public static class AliyunOssLibraryAccessors extends SubDependencyFactory {

        public AliyunOssLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.aliyun.dpa:oss-android-sdk</b> coordinates and
         * with version reference <b>aliyun.oss</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class AliyunTingwuLibraryAccessors extends SubDependencyFactory {

        public AliyunTingwuLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.aliyun:alibabacloud-tingwu20230930</b> coordinates and
         * with version reference <b>tingwu.sdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getSdk() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("aliyun.tingwu.sdk");
        }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>compose.lifecycle</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
     ...
     */
    @Deprecated
    public static class DashscopeLibraryAccessors extends SubDependencyFactory {

        public DashscopeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.alibaba:dashscope-sdk-java</b> coordinates and
         * with version reference <b>dashscope</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final AliyunVersionAccessors vaccForAliyunVersionAccessors = new AliyunVersionAccessors(providers, config);
        ...
        private final TingwuVersionAccessors vaccForTingwuVersionAccessors = new TingwuVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>dashscope</b> with value <b>2.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDashscope() { return getVersion("dashscope"); }
        ...
        /**
         * Group of versions at <b>versions.aliyun</b>
         */
        public AliyunVersionAccessors getAliyun() {
            return vaccForAliyunVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.tingwu</b>
         */
        public TingwuVersionAccessors getTingwu() {
            return vaccForTingwuVersionAccessors;
        }

    }

    public static class AliyunVersionAccessors extends VersionFactory  {

        private final AliyunSdkVersionAccessors vaccForAliyunSdkVersionAccessors = new AliyunSdkVersionAccessors(providers, config);
        public AliyunVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>aliyun.oss</b> with value <b>2.9.13</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOss() { return getVersion("aliyun.oss"); }

        /**
         * Group of versions at <b>versions.aliyun.sdk</b>
         */
        public AliyunSdkVersionAccessors getSdk() {
            return vaccForAliyunSdkVersionAccessors;
        }

    }

    public static class AliyunSdkVersionAccessors extends VersionFactory  {

        public AliyunSdkVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>aliyun.sdk.core</b> with value <b>4.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCore() { return getVersion("aliyun.sdk.core"); }
    ...
    public static class AndroidxActivityVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.activity.compose</b> with value <b>1.9.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxLifecycleVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Group of versions at <b>versions.androidx.lifecycle.viewmodel</b>
         */
    ...
    public static class AndroidxLifecycleViewmodelVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.lifecycle.viewmodel.ktx</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class TingwuVersionAccessors extends VersionFactory  {

        public TingwuVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>tingwu.sdk</b> with value <b>2.0.24</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSdk() { return getVersion("tingwu.sdk"); }
    ...
    public static class ComposeBundleAccessors extends BundleFactory {
        ...
        public ComposeBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, AttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }
