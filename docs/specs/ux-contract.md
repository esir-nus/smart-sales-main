...
>
> For **HOW** things are presented (states, microcopy, timing, layout), see [`ux-experience.md`](../plans/ux-experience.md).
>
...
> **Experience spec**: See [ux-experience.md#l3-smartanalysis-card](../plans/ux-experience.md#l3-smartanalysis-card) for card layout details.
...
|-------|-----------------|
| Chat flow states | [ux-experience.md#chat-flow](../plans/ux-experience.md#chat-flow) |
| Audio upload flow states | [ux-experience.md#audio-upload-flow](../plans/ux-experience.md#audio-upload-flow) |
| Transcription flow states | [ux-experience.md#transcription-flow](../plans/ux-experience.md#transcription-flow) |
| Layout invariants | [ux-experience.md#layout-invariants](../plans/ux-experience.md#layout-invariants) |
| Timing rules | [ux-experience.md#timing--feedback](../plans/ux-experience.md#timing--feedback) |
