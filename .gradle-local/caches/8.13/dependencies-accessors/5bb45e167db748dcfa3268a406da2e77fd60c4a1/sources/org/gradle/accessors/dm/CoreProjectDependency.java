...
public class CoreProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":core:util"
     */
    public Core_UtilProjectDependency getUtil() { return new Core_UtilProjectDependency(getFactory(), create(":core:util")); }
