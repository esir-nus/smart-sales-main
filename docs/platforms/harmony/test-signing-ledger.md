...
> Canonical protocol: `docs/specs/device-loop-protocol.md` -- this section is the originating evidence note that proved the loop. New L3 sprints follow the canonical doc; this section is preserved as historical proof.
