...
@NonNullApi
public class MainAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MainAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
    ...
    /**
     * Creates a project dependency on the project at path ":tingwuTestApp"
     */
    public TingwuTestAppProjectDependency getTingwuTestApp() { return new TingwuTestAppProjectDependency(getFactory(), create(":tingwuTestApp")); }
