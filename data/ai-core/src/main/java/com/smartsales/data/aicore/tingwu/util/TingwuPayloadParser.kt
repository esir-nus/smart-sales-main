...
internal object TingwuPayloadParser {
    ...
    /**
     * Formats milliseconds to time string (MM:SS or HH:MM:SS).
     * Consolidated from 3 duplicates across TingwuRunner, TranscriptFormatter, TranscriptEnhancerRenderer.
     */
