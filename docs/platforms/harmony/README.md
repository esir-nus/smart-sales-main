...
Use `docs/projects/harmony-native/tracker.md` for Harmony program-summary state such as capability boundaries, restore posture, and backend/dataflow summary.
