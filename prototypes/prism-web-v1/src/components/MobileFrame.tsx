...
export const MobileFrame: React.FC<MobileFrameProps> = ({ children }) => {
  return (
    <div className="relative w-[375px] h-[812px] bg-prism-bg shadow-2xl rounded-[44px] overflow-hidden border-[8px] border-gray-900 box-content ring-4 ring-gray-900/20">
