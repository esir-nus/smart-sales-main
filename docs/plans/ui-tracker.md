...
| SIM Scheduler Drawer Prototype | Top-anchored dark frosted slab sliding over SIM shell canvas | Review Pending | Prototype built with 7 mapped states merging the heavy SIM shell identity with the old scheduler IA. Waiting for human visual review of the HTML artifact before Android/Compose transplant phase. |
