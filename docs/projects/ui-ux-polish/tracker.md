...
| 04 | default-first-priority | rejected | Product rule superseded the Sprint 04 default-first objective: automatic recovery now targets the latest connected/active badge only, while default remains cosmetic/passive and non-active badges remain proximity/card state until manual user switch. | [sprints/04-default-first-priority.md](sprints/04-default-first-priority.md) |
