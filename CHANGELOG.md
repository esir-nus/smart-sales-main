...
- **[发布] 鸿蒙OS 日程 Phase 2B 交付** — 完成 HS-006 Phase 2B，补齐鸿蒙OS日程链路的本轮交付范围。
...
- **[新增] 鸿蒙OS Tingwu 音频链路加固** — 对 HS-010 音频管线进行加固，降低鸿蒙OS端 Tingwu 处理不稳定问题。
- **[修复] 鸿蒙OS Tingwu L3 收尾缺口** — 补齐 HS-010 L3 遗留问题，减少鸿蒙OS音频结果偏差与后续返工。
...
- **[修复] 鸿蒙OS Tingwu 说话人区分与详情展示对齐** — 调整 Tingwu diarization 与详情 UI 映射，减少人物区分和结果展示错位。
